#### Code example
---
The first version is not understandable because its function is not clearly defined. The second version uses clean code principles to give meaning to the code so that any user can understand it, in addition to refactoring and dividing tasks for better comprehension.
